...
export default function ArchivePage() {
  const articles = getArticlesByCategory("archive");
  return (
    <div className="flex-1 min-w-0">
      <h1 className="text-2xl sm:text-3xl font-extrabold mb-2">Archive</h1>
      <p className="text-slate-500 mb-8">Historical interview content ({articles.length} articles)</p>
