        ...
        >
          ...
          <div style={{
            ...
            <div style={{ textAlign: "right" }}>
              ...
              <div style={{ color: "#fff", fontSize: 18, fontWeight: 900, letterSpacing: -0.5 }}>BornoFlow</div>
              <div style={{ color: "rgba(255,255,255,0.5)", fontSize: 10, marginTop: 2 }}>bornosoftnr.com</div>
            </div>
          </div>
