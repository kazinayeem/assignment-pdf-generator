...
import { ArrowLeft, BookOpen, Zap, Code2 } from "lucide-react";

export default function ComingSoonPage() {
  const topicName = "Cryptography";
  const description = "Learn encryption algorithms, hashing, digital signatures, and public-key cryptography for secure communications";
  const parentPath = "/tools/security";
  const parentLabel = "Cyber Security";
  const icon = "🔑";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl font-black text-slate-900 mb-4 leading-tight">{topicName}</h1>
          ...
          <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 inline-block mb-8">
            <p className="text-sm text-blue-900">
              <span className="font-bold">Estimated Release:</span> Q2 2026
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm">
                  Visualize encryption, hashing and cryptographic concepts
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm">
                  Practical implementations in Python, JavaScript, and more
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-sky-50 to-blue-50 rounded-2xl border-2 border-sky-200 p-10 text-center">
          ...
          <p className="text-slate-600 mb-6">
            Subscribe to get notified when {topicName} is ready
          </p>
        ...
        <div className="mt-16 bg-amber-50 border-l-4 border-amber-500 rounded-r-lg p-6">
          <p className="text-sm text-amber-900">
            <strong>💡 In the meantime:</strong> Explore other available learning modules and start mastering the fundamentals!
          </p>
        </div>
      </div>
    </div>
