...
export function ProductivitySection() {
  return (
    <section className="section-padding relative bg-white dark:bg-slate-900/50">
      <div className="blur-orb w-[400px] h-[400px] bg-brand-accent/8 -bottom-20 -left-20" aria-hidden />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-12 md:mb-16">
          ...
          <Link
            href="/tools"
            className="inline-flex items-center gap-1 text-sm font-semibold text-brand hover:text-[#8B5CF6] transition-colors shrink-0 min-h-[44px]"
          >
            ...
            >
              <Link href={feature.href} className="block h-full group">
                <div className="glass-card h-full p-8 flex flex-col">
                  <div
                    className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${feature.color} flex items-center justify-center mb-6 shadow-lg group-hover:shadow-xl group-hover:shadow-brand/20 transition-all group-hover:scale-105`}
                  >
                  ...
                  <span className="inline-flex items-center gap-2 text-sm font-semibold text-brand group-hover:gap-3 transition-all min-h-[44px]">
