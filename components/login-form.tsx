...
function LoginFormInner() {
  ...
  // Handle error query param (e.g. ?error=AccessDenied from OAuth)
  useEffect(() => {
    ...
    <div className="w-full max-w-[440px] space-y-8">
      ...
      <Card className="p-8 rounded-[2.5rem] border-gray-100 shadow-2xl shadow-gray-200/50 bg-white space-y-6">
        ...
        <div className="space-y-4">
          <p className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 text-center mb-2">
          ...
          <div className="relative py-2">
            ...
            <div className="relative flex justify-center text-[10px] uppercase font-black tracking-widest">
              <span className="bg-white px-4 text-gray-300">DIU Identity</span>
            </div>
          </div>
          ...
          <div className="space-y-3 bg-blue-50/50 rounded-2xl p-5 border border-blue-100/50">
            <div className="flex items-start gap-3">
              ...
              <p className="text-[11px] text-blue-900 font-medium leading-relaxed">
                Use your official <span className="font-black">@diu.edu.bd</span> email to unlock
                course auto-filling and teacher selection features.
              </p>
            </div>
          </div>
        </div>
...
// Exported component wraps the inner one in Suspense (required by Next.js
// when useSearchParams is used inside a client component during prerender)
