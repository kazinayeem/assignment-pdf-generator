...
export default function UpcomingPage() {
  const articles = getArticlesByCategory("upcoming");
  return (
    <div className="flex-1 min-w-0">
      <h1 className="text-2xl sm:text-3xl font-extrabold mb-2">Upcoming Content</h1>
      <p className="text-slate-500 mb-8">{articles.length} planned articles</p>
