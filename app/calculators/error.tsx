...
export default function CalculatorsError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4 py-16">
      <div className="text-center max-w-md w-full">
        ...
        <h1 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Calculator error</h1>
        <p className="text-sm text-slate-500 dark:text-slate-400 mb-6" role="alert">
          {error.message || "Something went wrong while loading this calculator."}
        </p>
