  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4 py-16">
      <div className="text-center max-w-md w-full">
        ...
        <h1 className="text-xl font-bold text-foreground mb-2">Exam error</h1>
        <p className="text-sm text-muted-foreground mb-6" role="alert">
          {error.message || "Something went wrong with the exam module."}
        </p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          >
            <GraduationCap className="w-4 h-4" aria-hidden /> Exam Hub
          </Link>
        </div>
      </div>
    </div>
