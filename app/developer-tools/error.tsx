...
export default function DevToolsError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4 py-16">
      <div className="text-center max-w-md w-full">
        ...
        <h1 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Tool error</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link href="/developer-tools" className="inline-flex items-center justify-center gap-2 min-h-[44px] px-5 py-2.5 rounded-xl text-sm font-semibold border border-slate-200 dark:border-white/10">
            <Wrench className="w-4 h-4" aria-hidden /> All Tools
          </Link>
        </div>
      </div>
    </div>
